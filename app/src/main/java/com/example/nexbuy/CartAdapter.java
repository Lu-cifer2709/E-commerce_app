...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.title.setText(productModel.getProdName());
        holder.price.setText(productModel.getProdPrice());
        holder.qty.setText(productModel.getProdQty());

        Glide.with(context).load(productModel.getProdImg())
                .into(holder.img);
